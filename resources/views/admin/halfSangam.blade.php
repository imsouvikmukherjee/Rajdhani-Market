  ...
  <main id="main" class="main">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row market-btn mt-3">
                <div class="col-6">
                  <h3 class="card-title">Half Sangam</h3>
                </div>
                    ...
                    <table class="table table-striped list table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th class="align-left">Open Digit</th>
                          <th class="align-left">Close Digit</th>
                      ...
                      <tbody>
                        @foreach ($halfSangams as $item => $value)
                        <tr class="align-items-center">
                          <td>{{$value->market_name}}</td>
                          <td>{{$value->game_name}}</td>
                          {{-- <td>{{$value->digit}}</td> --}}
                          <td>{{$value->open_digits}}</td>
                          <td>{{$value->close_digits}}</td>
    ...
    @endif
                         ...
                         <!--@endif-->
                          ...
                          <td>
                            <a href="javascript:void(0)" onclick="confirmDelete('{{url('delete-half_sangam')}}/{{encrypt($value->id)}}')" class="btn btn-outline-danger"><i class="bi bi-trash-fill"></i></a>
                          </td>
                        </tr>
                    ...
                    <br>
                    {{-- {{ $halfSangams->links('pagination::bootstrap-5') }} --}}
                  </div>
                </div>
              </div>
