    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Add Gali Disawar</li>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="table-responsive mt-1">
                  <div pageindex="1">
                    <form class="row form-div" action="{{route('add_gali_store')}}" method="POST">
                        @csrf
                      <div class="row g-3 align-items-center">
                        <h3>Add Gali Disawar</h3>
                      </div>
                      <hr>
                      </hr>
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" spellcheck="false" name="result"
