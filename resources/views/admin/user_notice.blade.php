          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row market-btn mt-3">
                <div class="col-6">
                  <h3 class="card-title">User Notice</h3>
                </div>
                ...
                <div class="col-6 market-btn-div">
                  ...
                  <div>
                    <a href="{{route('add_notice')}}"><button type="btn" id="btn1"><i class="bi bi-plus-circle"></i><span>Add New</span></button></a>
                  </div>
                  {{-- <div>
                ...
                <div class="table-responsive mt-5">
                  <div pageindex="1">
                    ...
                    <table class="table table-striped list table-bordered">
                      <thead>
                        <tr>
                          <th class="align-items-left">Notice Title</th>
                          <th class="align-items-left">Description</th>
                          <th class="align-items-left">Published_at</th>
                      ...
                      <tbody>
                        ...
                        <tr class="align-items-center">
                          ...
                          <td>
                            ...
                            <a  href="javascript:void(0)" onclick="confirmDelete('{{url('/admin/notice-delete')}}/{{encrypt($item->id)}}')" class="btn btn-outline-danger"><i class="bi bi-trash-fill"></i></a>
                          </td>
                        </tr>
                        @endforeach
