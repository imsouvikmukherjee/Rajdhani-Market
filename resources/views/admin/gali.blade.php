          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row market-btn mt-3">
                <div class="col-6">
                  <h3 class="card-title">Gali Disawar</h3>
                </div>
                ...
                <div class="col-6 market-btn-div">
                  ...
                  <div>
                    <a href="{{route('add_gali')}}"><button type="btn" id="btn1"><i class="bi bi-plus-circle"></i><span>Add New</span></button></a>
                  </div>
                  {{-- <div>
                  ...
                  <div>
                    <a href="{{route('gali')}}"><button type="btn" id="btn1"><i class="bi bi-arrow-clockwise"></i><span>Refresh</span></button></a>
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            ...
                  @endif
                  <div pageindex="1">
                    <table class="table table-striped list table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th class="align-items-left">Result</th>
                      ...
                      <tbody>
                        ...
                        <tr class="align-items-center">
                          ...
                          <td>
                            ...
                            <a href="{{url('/gali-edit')}}/{{encrypt($item->id)}}" class="btn btn-outline-primary"><i class="bi bi-pencil-square"></i></a>
                            <a href="javascript:void(0)" onclick="confirmDelete('{{url('gali-delete')}}/{{encrypt($item->id)}}')" class="btn btn-outline-danger"><i class="bi bi-trash-fill"></i></a>
                          </td>
                        </tr>
                    ...
                    {{ $gali_data->links('pagination::bootstrap-5') }}
                  </div>
                </div>
              </div>
