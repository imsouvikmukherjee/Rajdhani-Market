          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row market-btn mt-3">
                <div class="col-6">
                  <h3 class="card-title">Games Rate</h3>
                </div>
                ...
                <div class="col-6 market-btn-div">
                  ...
                  <div>
                    <a href="{{route('game_types')}}"><button type="btn" id="btn1"><i class="bi bi-plus-circle"></i><span>Add New</span></button></a>
                  </div>
                  <div>
                      ...
                      <tbody>
                        ...
                        <tr class="align-items-center">
                          ...
                          <td>
                            ...
                            <a onclick="return cnfrm();" href="{{url('game_types/delete')}}/{{encrypt($gameTypeData->id)}}" class="btn btn-outline-danger"><i class="bi bi-trash-fill"></i></a>
                          </td>
                        </tr>
