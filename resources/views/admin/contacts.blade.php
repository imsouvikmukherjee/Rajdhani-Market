                ...
                <div class="table-responsive mt-3">
                  <div pageindex="1">
                    <form class="row form-div">
                      <div class="row g-3 ">
                        <div class="col-sm-12 col-md-6 "><h3>Search Contacts</h3></div>
                      ...
                      <div class="form-group row formdiv">
                        <label class="col-sm-3 text-right control-label col-form-label">Whatsapp Number</label>
                  ...
                  <div class="row g-3 align-items-center mt-1 formbutton">
                    ...
                    <div class="col-auto ">
                      <a href="contacts.html"><button type="button" class="btn btn-outline-danger">Close</button></a>

                    </div>
                    <div class="col-auto ">
                        <a href="contacts.html"><button type="button" class="btn btn-outline-dark">Reset</button></a>
                ...
                <div class="table-responsive mt-5">
                  <div pageindex="1">
                    <table class="table table-striped list table-bordered">
                      <thead>
                        <tr>
                          <th class="align-items-left">Phone</th>
                          <th class="align-items-left">Whatsapp Number</th>
