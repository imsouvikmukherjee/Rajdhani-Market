          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row market-btn mt-3">
                <div class="col-6">
                  <h3 class="card-title">Full Sangam</h3>
                </div>
                ...
                <div class="table-responsive mt-5">
                  <div pageindex="1">
                    ...
                    <table class="table table-striped list table-bordered">
                      ...
                      <tbody>
                        @foreach ($fullSangams as $item => $value)
...
{{--                     
                         ...
                         <!--@endif-->
                          ...
                          <td>
                            <a href="javascript:void(0)" onclick="confirmDelete('{{url('delete-full_sangam')}}/{{encrypt($value->id)}}')" class="btn btn-outline-danger"><i class="bi bi-trash-fill"></i></a>
                          </td>
                        </tr>
