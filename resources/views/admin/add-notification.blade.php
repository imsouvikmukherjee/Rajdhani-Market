                  ...
                  <div pageindex="1">
                    <form class="row form-div">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9">
                                <textarea  class="form-control" spellcheck="false" name="s_open_pana" id="s_open_pana"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="row g-3 align-items-center mt-1">
                      ...
                      <div class="col-auto ">
                        <a href="notafication.html"><button type="button" class="btn btn-primary">Save</button></a>
  
                      </div>
                      <div class="col-auto ">
                        <a href="notafication.html"><button type="button" class="btn btn-dark">Go Back</button></a>
