                ...
                <div class="table-responsive mt-3">
                  <div pageindex="1">
                    <form class="row form-div">
                      <div class="row g-3 ">
                        <div class="col-sm-12 col-md-6 "><h3>Search Limits</h3></div>
                      ...
                      <div class="form-group row formdiv">
                        <label class="col-sm-3 text-right control-label col-form-label">Deposit Minimum Limit Amount</label>
                      ...
                      <div class="form-group row formdiv ">
                        <label class="col-sm-3 text-right control-label col-form-label">Withdraw Minimum Limit Amount</label>
                      ...
                      <div class="form-group row formdiv ">
                        <label class="col-sm-3 text-right control-label col-form-label">Withdraw Query Number</label>
                      ...
                      <div class="form-group row formdiv ">
                        <label class="col-sm-3 text-right control-label col-form-label">Withdraw Text</label>
                  ...
                  <div class="row g-3 align-items-center mt-1 formbutton">
                    ...
                    <div class="col-auto ">
                      <a href="Minimum_limit.html"><button type="button" class="btn btn-outline-danger">Close</button></a>

                    </div>
                    <div class="col-auto ">
                        <a href="Minimum_limit.html"><button type="button" class="btn btn-outline-dark">Reset</button></a>
                ...
                <div class="table-responsive mt-5">
                  <div pageindex="1">
                    <table class="table table-striped list table-bordered">
                      <thead>
                        <tr>
                          <th class="align-items-left">Deposit Minimum Limit Amount</th>
                          <th class="align-items-left">Withdraw Minimum Limit Amount</th>
