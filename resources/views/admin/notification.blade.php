            ...
            <div class="card-body">
              ...
              <div class="row market-btn mt-3">
                ...
                <div class="col-6 market-btn-div">
                  <div>
                    <a href="add-notification.html"><button type="btn" id="btn1"><i class="bi bi-plus-circle"></i><span>Add New</span></button></a>
                  </div>
                  <div>
                ...
                <div class="table-responsive mt-3">
                  <div pageindex="1">
                    <form class="row form-div">
                      <div class="row g-3 ">
                        <div class="col-sm-12 col-md-6 "><h3>Search Notifications</h3></div>
                  ...
                  <div class="row g-3 align-items-center mt-1 formbutton">
                    ...
                    <div class="col-auto ">
                      <a href="notafication.html"><button type="button" class="btn btn-outline-danger">Close</button></a>

                    </div>
                    <div class="col-auto ">
                        <a href="notafication.html"><button type="button" class="btn btn-outline-dark">Reset</button></a>
                ...
                <div class="table-responsive mt-5">
                  <div pageindex="1">
                    <table class="table table-striped list table-bordered">
                      <thead>
                        <tr>
                          <th class="align-items-left">Title</th>
                          <th class="align-items-left">Message</th>
                          <!-- <th class="align-left">Number</th>
                          <th class="align-left">Amount</th>
                          <th class="align-left">Userbalance</th>
