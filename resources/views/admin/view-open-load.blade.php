        ...
        <div class="pagetitle">
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">openload</li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row market-btn mt-3">
                                <div class="col-6">
                                    <h3 class="card-title">Open Load</h3>
                                </div>
                                <!-- <div class="col-sm-4"></div> -->
                                <!-- <div class="col-6 market-btn-div">
                  <div>
                    <a href="add-declare.html"><button type="btn" id="btn1"><i class="bi bi-plus-circle"></i><span>Add
                          New</span></button></a>
                  </div>
                  <div>
