    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Starline Markets</li>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="table-responsive mt-1">
                  <div pageindex="1">
                    <form class="row form-div" action="{{route('starline_games_store')}}" method="POST">
                        @csrf
                      <div class="row g-3 align-items-center">
                        <h3>Add Starline Markets</h3>
                      </div>
                      <hr>
                      </hr>
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" spellcheck="false" name="market_name"
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                          <input type="time" class="form-control" spellcheck="false" value="" name="time"
                            id="s_open_pana" />
                            @error('time')
                            <div class="text-danger">{{ $message }}</div>
                           @enderror
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" spellcheck="false" name="open_pana"
                            id="s_open_pana"></input>
                            @error('open_pana')
                            <div class="text-danger">{{ $message }}</div>
                           @enderror
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" spellcheck="false" name="open_result"
                            id="s_open_pana"></input>
                            @error('open_result')
                            <div class="text-danger">{{ $message }}</div>
                           @enderror
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" spellcheck="false" name="close_pana"
                            id="s_open_pana"></input>
                            @error('close_pana')
                            <div class="text-danger">{{ $message }}</div>
                           @enderror
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" spellcheck="false" name="close_result"
                            id="s_open_pana"></input>
                            @error('close_result')
                            <div class="text-danger">{{ $message }}</div>
                           @enderror
