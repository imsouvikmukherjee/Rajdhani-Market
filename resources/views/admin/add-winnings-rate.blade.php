                ...
                <div class="table-responsive mt-5">
                  <div pageindex="1">
                    ...
                    <div class="row g-3 align-items-center mt-1">
                      ...
                      <div class="col-auto ">
                        <a href="winning_rates.html"><button type="button" class="btn btn-primary">Save</button></a>
  
                      </div>
                      <div class="col-auto ">
                        <a href="winning_rates.html"><button type="button" class="btn btn-dark">Go Back</button></a>
