    ...
    <div class="container vh-100 d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="p-1" style="width: 100%; max-width: 500px;">
            <form class="row g-3">
                <div class="col-12">
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" class="form-control border-start-0" id="inputName" placeholder="Enter Your Name" required />
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="input-group input-group-lg">
                        ...
                        <input type="email" class="form-control border-start-0" id="inputEmail" placeholder="Enter Email" required />
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="input-group input-group-lg">
                        <span class="input-group-text bg-transparent"><i class='bx bxs-lock'></i></span>
                        <input type="password" class="form-control border-start-0" id="inputConfirmPassword" placeholder="Confirm Password" required />
                    </div>
                </div>
            ...
            <div class="text-center mt-3">
                <a href="{{route('login_user')}}" class="text-light">Log in to your Account</a>
            </div>
        </div>
    </div>
