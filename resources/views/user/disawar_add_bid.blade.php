    ...
    <div class="container text-center mt-4">
        <div class="container  d-flex flex-column justify-content-center align-items-center">
            <div class="text-center mb-4 mt-1">
                ...
                <h2 class="mb-4">{{$gamename}} ({{$marketname}})</h2>
        ...
        @endif
                ...
                <form class="row g-3" action="{{url('/user/disawar-add-bid-store')}}/{{$marketname}}/{{$gamename}}" method="POST">
                    @csrf
                    ...
                    <div class="col-12">
                        <div class="input-group input-group-lg">
                            ...
                            <input type="Number" class="form-control border-start-0" id="inputEmail"
                                placeholder="ENTER Digit" name="game_digit"/>
                        </div>
                    </div>
